...
export function setCharTimeline() {
  ...
  if (window.innerWidth > 1024) {
    ...
    tl2
      ...
      .to(
        ".profile-avatar-figure",
        { scale: 0.88, rotateY: 24, rotateX: 4, delay: 3, duration: 3 },
        0
      )
      .fromTo(
        ".what-box-in",
    ...
    tl3
      ...
      .to(".profile-avatar-figure", { rotateX: -2, duration: 2, delay: 1 }, 0);
  } else {
...
export function setAllTimeline() {
  ...
  careerTimeline
    ...
    .fromTo(
      ".career-info-box, .career-earlier",
      { opacity: 0 },
